...
class Container(Type):
    ...
    @typecheck
    def as_tarball(self, *, platform_variants: Optional[Sequence["Container"]] = None, forced_compression: Optional[ImageLayerCompression] = None, media_types: Optional[ImageMediaTypes] = None,) -> "File":
    ...
    @typecheck
    def build(self, context: "Directory", *, dockerfile: Optional[str] = None, build_args: Optional[Sequence[BuildArg]] = None, target: Optional[str] = None, secrets: Optional[Sequence["Secret"]] = None,) -> "Container":
    ...
    @typecheck
    async def export(self, path: str, *, platform_variants: Optional[Sequence["Container"]] = None, forced_compression: Optional[ImageLayerCompression] = None, media_types: Optional[ImageMediaTypes] = None,) -> bool:
    ...
    async def exposed_ports(self) -> list["Port"]:
        ...
        _ctx = Port(_ctx)._select_multiple(_description="description", _port="port", _protocol="protocol",)
    ...
    @typecheck
    def import_(self, source: "File", *, tag: Optional[str] = None,) -> "Container":
    ...
    @typecheck
    def pipeline(self, name: str, *, description: Optional[str] = None, labels: Optional[Sequence[PipelineLabel]] = None,) -> "Container":
    ...
    @typecheck
    async def publish(self, address: str, *, platform_variants: Optional[Sequence["Container"]] = None, forced_compression: Optional[ImageLayerCompression] = None, media_types: Optional[ImageMediaTypes] = None,) -> str:
    ...
    @typecheck
    def with_directory(self, path: str, directory: "Directory", *, exclude: Optional[Sequence[str]] = None, include: Optional[Sequence[str]] = None, owner: Optional[str] = None,) -> "Container":
    ...
    @typecheck
    def with_env_variable(self, name: str, value: str, *, expand: Optional[bool] = None,) -> "Container":
    ...
    @typecheck
    def with_exec(self, args: Sequence[str], *, skip_entrypoint: Optional[bool] = None, stdin: Optional[str] = None, redirect_stdout: Optional[str] = None, redirect_stderr: Optional[str] = None, experimental_privileged_nesting: Optional[bool] = None, insecure_root_capabilities: Optional[bool] = None,) -> "Container":
    ...
    @typecheck
    def with_exposed_port(self, port: int, *, protocol: Optional[NetworkProtocol] = None, description: Optional[str] = None,) -> "Container":
    ...
    @typecheck
    def with_file(self, path: str, source: "File", *, permissions: Optional[int] = None, owner: Optional[str] = None,) -> "Container":
    ...
    @typecheck
    def with_mounted_cache(self, path: str, cache: CacheVolume, *, source: Optional["Directory"] = None, sharing: Optional[CacheSharingMode] = None, owner: Optional[str] = None,) -> "Container":
    ...
    @typecheck
    def with_mounted_directory(self, path: str, source: "Directory", *, owner: Optional[str] = None,) -> "Container":
    ...
    @typecheck
    def with_mounted_file(self, path: str, source: "File", *, owner: Optional[str] = None,) -> "Container":
    ...
    @typecheck
    def with_mounted_secret(self, path: str, source: "Secret", *, owner: Optional[str] = None, mode: Optional[int] = None,) -> "Container":
    ...
    @typecheck
    def with_new_file(self, path: str, *, contents: Optional[str] = None, permissions: Optional[int] = None, owner: Optional[str] = None,) -> "Container":
    ...
    @typecheck
    def with_unix_socket(self, path: str, source: "Socket", *, owner: Optional[str] = None,) -> "Container":
    ...
    @typecheck
    def without_exposed_port(self, port: int, *, protocol: Optional[NetworkProtocol] = None,) -> "Container":
...
class Directory(Type):
    ...
    @typecheck
    def as_module(self, *, source_subpath: Optional[str] = None,) -> "Module":
    ...
    @typecheck
    def docker_build(self, *, dockerfile: Optional[str] = None, platform: Optional[Platform] = None, build_args: Optional[Sequence[BuildArg]] = None, target: Optional[str] = None, secrets: Optional[Sequence["Secret"]] = None,) -> Container:
    ...
    @typecheck
    def pipeline(self, name: str, *, description: Optional[str] = None, labels: Optional[Sequence[PipelineLabel]] = None,) -> "Directory":
        """Creates a named sub-pipeline
    ...
    @typecheck
    def with_directory(self, path: str, directory: "Directory", *, exclude: Optional[Sequence[str]] = None, include: Optional[Sequence[str]] = None,) -> "Directory":
    ...
    @typecheck
    def with_file(self, path: str, source: "File", *, permissions: Optional[int] = None,) -> "Directory":
    ...
    @typecheck
    def with_new_directory(self, path: str, *, permissions: Optional[int] = None,) -> "Directory":
    ...
    @typecheck
    def with_new_file(self, path: str, contents: str, *, permissions: Optional[int] = None,) -> "Directory":
...
class File(Type):
    ...
    @typecheck
    async def export(self, path: str, *, allow_parent_dir_path: Optional[bool] = None,) -> bool:
...
class Function(Type):
    ...
    @typecheck
    def with_arg(self, name: str, type_def: "TypeDef", *, description: Optional[str] = None, default_value: Optional[JSON] = None,) -> "Function":
...
class GitRef(Type):
    ...
    @typecheck
    def tree(self, *, ssh_known_hosts: Optional[str] = None, ssh_auth_socket: Optional["Socket"] = None,) -> Directory:
...
class Host(Type):
    ...
    @typecheck
    def directory(self, path: str, *, exclude: Optional[Sequence[str]] = None, include: Optional[Sequence[str]] = None,) -> Directory:
    ...
    @typecheck
    def service(self, ports: Sequence[PortForward], *, host: Optional[str] = "localhost",) -> "Service":
    ...
    @typecheck
    def tunnel(self, service: "Service", *, native: Optional[bool] = False, ports: Optional[Sequence[PortForward]] = None,) -> "Service":
...
class Module(Type):
    ...
    __slots__ = ("_dependency_config", "_description", "_name", "_sdk", "_serve", "_source_directory_sub_path",)
    ...
    async def dependencies(self) -> list["Module"]:
        ...
        _ctx = Module(_ctx)._select_multiple(_dependency_config="dependencyConfig", _description="description", _name="name", _sdk="sdk", _serve="serve", _source_directory_sub_path="sourceDirectorySubPath",)
...
class Port(Type):
    ...
    __slots__ = ("_description", "_port", "_protocol",)
...
class Client(Root):
    ...
    @typecheck
    def container(self, *, id: Optional[ContainerID] = None, platform: Optional[Platform] = None,) -> Container:
    ...
    @typecheck
    def git(self, url: str, *, keep_git_dir: Optional[bool] = None, ssh_known_hosts: Optional[str] = None, ssh_auth_socket: Optional["Socket"] = None, experimental_service_host: Optional["Service"] = None,) -> GitRepository:
    ...
    @typecheck
    def http(self, url: str, *, experimental_service_host: Optional["Service"] = None,) -> File:
    ...
    @typecheck
    def module_config(self, source_directory: Directory, *, subpath: Optional[str] = None,) -> ModuleConfig:
    ...
    @typecheck
    def pipeline(self, name: str, *, description: Optional[str] = None, labels: Optional[Sequence[PipelineLabel]] = None,) -> "Client":
        """Creates a named sub-pipeline.
...
class Service(Type):
    ...
    @typecheck
    async def endpoint(self, *, port: Optional[int] = None, scheme: Optional[str] = None,) -> str:
...
class TypeDef(Type):
    ...
    @typecheck
    def with_field(self, name: str, type_def: "TypeDef", *, description: Optional[str] = None,) -> "TypeDef":
    ...
    @typecheck
    def with_object(self, name: str, *, description: Optional[str] = None,) -> "TypeDef":
